...
1. On the dashboard, create a new template using the Live Streaming preset
1. Specify a subdomain and region on the next screen

### Understand roles

![Live Streaming roles](/docs/v2/live-streaming-roles.png)

This preset configures your new template with [two roles](/javascript/v2/foundation/templates-and-roles). All rooms created based on this template will have this configuration.
